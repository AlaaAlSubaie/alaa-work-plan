...
export const T: Record<string, Entry> = {
  ...
  "app.sub": {
    ...
    ar: "دوّن يومك · تقرير أسبوعي حلو · تابِع كل مشاريعك",
  },
  ...
  "foot.note": {
    ...
    ar: "بياناتك تنحفظ تلقائي في هذا المتصفح على هذا الجهاز. خذ نسخة احتياطية بين فترة وفترة عبر التصدير — واستخدم نفس المتصفح كل مرة.",
  },
  "foot.export": { en: "Export backup", ar: "تصدير نسخة احتياطية" },
  "foot.import": { en: "Import backup", ar: "استيراد نسخة احتياطية" },

  // ---- login brand panel ----
  "login.headline": { en: "Plan the day. Ship the week.", ar: "رتّب يومك، وخلّص أسبوعك." },
  "login.tagline": {
    en: "Capture quick notes, track your team, and turn it all into a polished weekly report — in one calm workspace.",
    ar: "دوّن ملاحظاتك على طول، تابع فريقك، وحوّل كل شي لتقرير أسبوعي مرتّب — بمكان شغل واحد وهادي.",
  },
  ...
  "login.sub": { en: "Sign in to continue", ar: "سجّل دخولك عشان تكمّل" },
  "login.keep": { en: "Keep me signed in", ar: "خلّني داخل" },
  "login.tag": { en: "(01) — Daily practice", ar: "(٠١) — ممارسة يومية" },
  "login.vol": { en: "Vol. 1 · 2026", ar: "العدد ١ · ٢٠٢٦" },
  "login.label": { en: "Workspace access", ar: "الدخول لمساحة الشغل" },
  "login.headLead": { en: "Watch your day get", ar: "شوف يومك" },
  "login.headAccent": { en: "done", ar: "يتسوّى" },
  ...
  // ---- lock screen ----
  "lock.welcome": { en: "Welcome back", ar: "هلا والله، رجعت" },
  ...
  "lock.setupSub": {
    ...
    ar: "احمِ خطة شغلك على هذا الجهاز.",
  },
  "lock.enterSub": { en: "Enter your passcode to continue.", ar: "دخّل رمز الدخول عشان تكمّل." },
  "lock.passcode": { en: "Passcode", ar: "رمز الدخول" },
  "lock.confirm": { en: "Confirm passcode", ar: "أكّد رمز الدخول" },
  "lock.unlock": { en: "Unlock", ar: "دخول" },
  "lock.create": { en: "Create & enter", ar: "سوِّ وادخل" },
  "lock.errName": { en: "Enter your name", ar: "دخّل اسمك" },
  ...
  "lock.forgot": { en: "Forgot passcode? Reset", ar: "ناسي الرمز؟ صفّره" },
  "lock.resetConfirm": {
    en: "Reset the passcode? Your data stays on this device.",
    ar: "تبي تصفّر الرمز؟ بياناتك بتظل على هذا الجهاز.",
  },
  ...
  // ---- toasts & dialogs ----
  "toast.enterProjName": { en: "Enter a project name", ar: "دخّل اسم المشروع" },
  "toast.projectAdded": { en: "Project added", ar: "انضاف المشروع" },
  "toast.enterName": { en: "Enter a name", ar: "دخّل اسم" },
  "toast.taskAdded": { en: "Task added", ar: "انضافت المهمة" },
  "toast.pickRange": { en: "Pick a date range", ar: "اختر فترة أول" },
  "toast.genFirst": { en: "Generate a report first", ar: "سوِّ تقرير أول" },
  ...
  "toast.pickProj": { en: "Pick a project first", ar: "اختر مشروع أول" },
  "dlg.delProject": { en: "Delete this project?", ar: "تبي تمسح هذا المشروع؟" },
  "dlg.delEntry": { en: "Delete this entry?", ar: "تبي تمسح هذا المدخل؟" },
  "dlg.delSaved": { en: "Delete this saved report?", ar: "تبي تمسح هذا التقرير المحفوظ؟" },
  "dlg.delTask": { en: "Delete this task?", ar: "تبي تمسح هذه المهمة؟" },
  "dlg.projName": { en: "Project name:", ar: "اسم المشروع:" },
  "dlg.note": { en: "Note:", ar: "الملاحظة:" },
  "dlg.editTask": { en: "Edit task:", ar: "عدّل المهمة:" },
  "dlg.time": { en: "Time (HH:MM, leave empty for none):", ar: "الوقت (HH:MM، خلّه فاضي إذا ما تبي):" },

  // ---- common ----
  "c.add": { en: "Add", ar: "ضيف" },
  "c.clear": { en: "Clear", ar: "امسح" },
  "c.today": { en: "Today", ar: "اليوم" },
  "c.who": { en: "— who —", ar: "— منو —" },
  "c.copy": { en: "Copy", ar: "انسخ" },
  "c.open": { en: "Open", ar: "افتح" },
  ...
  "log.captureHint": {
    ...
    ar: "اكتب بسرعة بكلماتك — لا تهتم بالقواعد. اختر النوع وبعدها دوس Enter (أو زر الإضافة). كل شي ينحفظ تلقائي بتاريخ ووقت اليوم.",
  },
  "log.placeholder": {
    en: "e.g. finished the monthly safety report and sent it to the team…",
    ar: "مثلاً: خلّصت تقرير السلامة الشهري وطرشته للفريق…",
  },
  "log.yourLog": { en: "Your log", ar: "سجلّك" },
  "log.search": { en: "Search your entries…", ar: "دوّر في مدخلاتك…" },
  "log.allCats": { en: "All categories", ar: "كل الأنواع" },
  "log.empty": {
    en: "No entries yet. Capture your first task above ☝️",
    ar: "ما في مدخلات لحد الحين. سجّل أول مهمة فوق ☝️",
  },
  "log.toAgenda": {
    en: "Also add to today's agenda",
    ar: "ضيفها بعد لأجندة اليوم",
  },
  ...
  "ag.hint": {
    ...
    ar: "خطّط للشغل اللي ناوي تسوّيه، وبعدها علّم المهام أول ما تخلّصها. المهام اللي ما خلّصتها من أيام قبل تنرحّل تلقائي.",
  },
  ...
  "pr.hint": {
    ...
    ar: "اسحب اللوحة على جنب عشان تشوف كل المراحل. استخدم زرّي ◀ ▶ عشان تنقل البطاقة بين المراحل. حدّد تاريخ مستهدف عشان توصلك تذكيرات. دوس على التفاصيل عشان تتابع المهام والملاحظات وتعيّن أعضاء الفريق.",
  },
  ...
  "pr.addMember": { en: "＋ Add a member…", ar: "＋ ضيف عضو…" },
  "pr.noMembers": { en: "No members on this project yet — add from the menu.", ar: "ما في أعضاء في هذا المشروع — ضيف من القائمة." },
  "pr.addTeamFirst": { en: "Add team members in the “Manage team” panel above first.", ar: "ضيف أعضاء الفريق من لوحة «إدارة الفريق» فوق أول." },
  "pr.targetDate": { en: "Target date (reminder)", ar: "التاريخ المستهدف (تذكير)" },
  "pr.tasks": { en: "Tasks (assign & track)", ar: "المهام (تعيين ومتابعة)" },
  "pr.addTaskPh": { en: "Add a task…", ar: "ضيف مهمة…" },
  "pr.noTasks": { en: "No tasks yet.", ar: "ما في مهام لحد الحين." },
  "pr.issues": { en: "Issues to follow", ar: "ملاحظات للمتابعة" },
  "pr.addIssuePh": { en: "Add an issue…", ar: "ضيف ملاحظة…" },
  ...
  "tm.hint": {
    ...
    ar: "مهام كل عضو في كل المشاريع عشان تظل على اطّلاع. ضيف مهمة من بطاقة العضو — اختر مشروع من اللي مسند له. دوس على شارة الحالة عشان تغيّرها.",
  },
  "tm.hideDone": { en: "Hide completed tasks", ar: "خفّي المهام الخالصة" },
  "tm.inProgress": { en: "{n} in progress", ar: "{n} شغّالة" },
  "tm.pending": { en: "{n} pending", ar: "{n} بالانتظار" },
  "tm.done": { en: "{n} done", ar: "{n} خالصة" },
  "tm.addFor": { en: "Add a task for {name}…", ar: "ضيف مهمة لـ {name}…" },
  "tm.assignFirst": { en: "Assign {name} to a project first (in 📂 Projects) to add tasks here.", ar: "أسند {name} لمشروع أول (في 📂 المشاريع) عشان تقدر تضيف مهام هني." },
  ...
  "tb.active": { en: "Active now", ar: "شغّالة الحين" },
  "tb.completed": { en: "Completed", ar: "خالصة" },
  ...
  "tb.noTasks": {
    ...
    ar: "ما في مهام لحد الحين. ضيف وحدة فوق، أو سوِّ مهام في 📂 المشاريع.",
  },
  "tb.subMembers": {
    en: "{members} members · {active} active · {done} done",
    ar: "{members} أعضاء · {active} شغّالة · {done} خالصة",
  },
  "tb.tasksProjects": { en: "{tasks} tasks · {projects} projects", ar: "{tasks} مهام · {projects} مشاريع" },
  "tb.viewDetails": { en: "View details", ar: "شوف التفاصيل" },
  "tb.close": { en: "Close", ar: "سكّر" },
  ...
  "db.noAch": { en: "Nothing logged yet — add achievements in 📝 Daily Log.", ar: "ما في شي مسجّل لحد الحين — ضيف إنجازات في 📝 السجل اليومي." },
  ...
  "db.addTask": { en: "Add task", ar: "ضيف مهمة" },
  "db.openReport": { en: "Open report", ar: "افتح التقرير" },
  "db.quickActions": { en: "Quick actions", ar: "اختصارات سريعة" },
  "db.qaLog": { en: "Log entry", ar: "تدوين" },
  "db.qaPlan": { en: "Plan day", ar: "خطّط يومك" },
  "db.qaProject": { en: "New project", ar: "مشروع جديد" },
  "db.qaShare": { en: "Share report", ar: "شارك التقرير" },
  "db.allProjects": { en: "All projects", ar: "كل المشاريع" },
  "db.openBoard": { en: "Open board", ar: "افتح اللوحة" },
  "db.all": { en: "All", ar: "الكل" },
  "db.issuesN": { en: "{n} issues", ar: "{n} ملاحظات" },
  "db.activeTasksTitle": { en: "Team · active tasks", ar: "الفريق · المهام الشغّالة" },
  ...
  "db.viewAll": { en: "View all", ar: "شوف الكل" },
  ...
  "wr.hint": {
    ...
    ar: "كل اللي تكتبه في السجل اليومي (واللي تخلّصه في الأجندة) ضمن التواريخ المحددة ينجمع تلقائي. اختر الفترة، دوس إنشاء، حسّن الصياغة إذا تبي، وبعدها انسخ — أو احفظه عشان ترجع له أي وقت.",
  },
  ...
  "wr.enhance": { en: "Enhance writing", ar: "حسّن الصياغة" },
  "wr.save": { en: "Save report", ar: "احفظ التقرير" },
  "wr.copy": { en: "Copy", ar: "انسخ" },
  "wr.download": { en: "Download .txt", ar: "نزّل .txt" },
  "wr.reportPh": { en: "Your generated report will appear here…", ar: "تقريرك بيظهر هني…" },
  "wr.saved": { en: "Saved reports", ar: "التقارير المحفوظة" },
  "wr.noSaved": { en: "No saved reports yet. Generate one above and click 💾 Save.", ar: "ما في تقارير محفوظة لحد الحين. سوِّ واحد فوق ودوس 💾 احفظ." },
  "wr.savedAt": { en: "Saved", ar: "انحفظ" },
  "wr.pullEmpty": { en: "No Daily Log entries or completed agenda tasks in this period — try a wider date range.", ar: "ما في مدخلات في السجل اليومي ولا مهام أجندة خالصة في هالفترة — جرّب نطاق أوسع." },
  "wr.pull": {
    en: "{n} item(s) from your Daily Log & Agenda in this period will be pulled in. Click Generate.",
    ar: "{n} عنصر من السجل اليومي والأجندة في هالفترة بينضمّ. دوس إنشاء.",
  },
  "foot.copyright": {
